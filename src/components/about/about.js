...
function About() {
    return (
        <div>
            ...
            <ol>
                <li>
                    At Markrich Apparel, my role as Senior Associate Tech is to bring the cutting-edge
                ...
                <li>
                    Previously, as a Frontend Developer at Sublimis Technologies, I forged a strong link
