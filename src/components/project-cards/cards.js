...
function Cards() {
    return (
        ...
        <div class="col">
                    ...
                    <div class="card">
                        <img src='https://cdn.shopify.com/s/files/1/0613/1400/7297/files/Palmonas_Logo_Open_File-02.webp?v=1760074313/>
                        <div class="card-body">
                            <h5 class="card-title">Palmonas</h5>
                            <p class="card-text">Palmonas is an Indian jewelry brand specializing in demi-fine jewelry,
        which combines the affordability of fashion jewelry with the quality of fine jewelry.
        The brand offers waterproof, anti-tarnish pieces made from high-quality base metals like surgical steel or Sterling silver 925, plated with 18k gold</p>
                            <a href='https://palmonas.com/' class="button">Visit Website</a>
                        </div>
                    </div>
                </div>
                <div class="col">
